...
riverctl map normal Super G spawn "alacritty --class floating -o window.dimensions.columns=100 -o window.dimensions.lines=8"
...
riverctl map normal Super semicolon spawn "$config_dir/river/send-to-output.sh"
