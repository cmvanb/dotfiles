...
fish::install () {
    ...
    render-mako "$src/env.mako.fish" "$XDG_CONFIG_HOME/fish/env.fish"
    render-mako "$src/login.mako.fish" "$XDG_CONFIG_HOME/fish/login.fish"
    ...
    render-mako "$src/functions/fish_deployed_aliases.mako.fish" "$XDG_CONFIG_HOME/fish/functions/fish_deployed_aliases.fish"
