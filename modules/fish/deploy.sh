...
fish::install () {
    ...
    render_esh_template "$src/env.esh.fish" "$XDG_CONFIG_HOME/fish/env.fish"
    render_esh_template "$src/login.esh.fish" "$XDG_CONFIG_HOME/fish/login.fish"
    ...
    render_esh_template "$src/functions/fish_deployed_aliases.esh.fish" "$XDG_CONFIG_HOME/fish/functions/fish_deployed_aliases.fish"
