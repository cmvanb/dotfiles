...
fish::install () {
    ...
    render_esh_template "$src/env.fish~esh" "$XDG_CONFIG_HOME/fish/env.fish"
    render_esh_template "$src/login.fish~esh" "$XDG_CONFIG_HOME/fish/login.fish"
    ...
    render_esh_template "$src/functions/fish_deployed_aliases.fish~esh" "$XDG_CONFIG_HOME/fish/functions/fish_deployed_aliases.fish"
