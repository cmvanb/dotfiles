...
print_band 64 10 "$width" "$height"
print_band 74 10 "$width" "$height"
print_band 84 10 "$width" "$height"
print_band 94 10 "$width" "$height"
print_band 104 10 "$width" "$height"
print_band 114 10 "$width" "$height"
print_band 124 10 "$width" "$height"
print_band 134 10 "$width" "$height"
