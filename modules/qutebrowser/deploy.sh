...
qutebrowser::install () {
    ...
    fs::force_link "$src/styles/azure-devops.css" "$XDG_CONFIG_HOME/qutebrowser/styles/azure-devops.css"
...
qutebrowser::uninstall () {
    ...
    rm "$XDG_CONFIG_HOME/qutebrowser/styles/arch-linux-forum.css"
    rm "$XDG_CONFIG_HOME/qutebrowser/styles/arch-linux-wiki.css"
    ...
    rm "$XDG_CONFIG_HOME/qutebrowser/styles/azure-devops.css"
