...
c.colors.hints.bg = f'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 {theme.color_css_rgba('purple_3', 1.0)}, stop:1 {theme.color_css_rgba('purple_0', 1.0)})'
...
c.tabs.padding = { 'top': 1, 'bottom': 4, 'left': 10, 'right': 8 }
c.tabs.position = 'top'
c.tabs.title.alignment = 'left'
c.tabs.title.format = ' {audio}{current_title}'

c.colors.tabs.bar.bg = theme.color_hash('gray_1')
...
config.bind('<Ctrl-i>', 'spawn --userscript qute-rbw --submit', mode='insert')
config.bind('<Ctrl-Shift-i>', 'spawn --userscript qute-rbw --select')
