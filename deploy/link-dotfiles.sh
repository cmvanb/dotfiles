...
force_link "$source_dir/.local/bin/rg" "$bin_dir/rg"
...
force_link "$source_dir/.config/systemd/user/mako.service" "$config_dir/systemd/user/mako.service"
force_link "$source_dir/.config/systemd/user/ssh-agent.service" "$config_dir/systemd/user/ssh-agent.service"
force_link "$source_dir/.config/systemd/user/udiskie.service" "$config_dir/systemd/user/udiskie.service"
