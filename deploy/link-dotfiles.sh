...
force_link "$source_dir/.config/direnv" "$config_dir/direnv"
...
force_link "$source_dir/.config/python" "$config_dir/python"
mkdir -p "$config_dir/hypr"
force_link "$source_dir/.config/hypr/hyprland.conf" "$config_dir/hypr/hyprland.conf"
...
force_link "$source_dir/.config/river/environment.sh" "$config_dir/river/environment.sh"
force_link "$source_dir/.config/river/init" "$config_dir/river/init"
force_link "$source_dir/.config/river/send-and-focus-output.sh" "$config_dir/river/send-and-focus-output.sh"
force_link "$source_dir/.config/river/send-to-output.sh" "$config_dir/river/send-to-output.sh"
...
force_link "$source_dir/.config/systemd/user/xdg-desktop-portal-gtk.service" "$config_dir/systemd/user/xdg-desktop-portal-gtk.service"
mkdir -p "$config_dir/theme"
force_link "$source_dir/.config/theme/carbon-dark" "$config_dir/theme/carbon-dark"
force_link "$source_dir/.config/theme/carbon-light" "$config_dir/theme/carbon-light"
force_link "$source_dir/.config/theme/fonts" "$config_dir/theme/fonts"
...
force_link "$source_dir/.config/xdg-desktop-portal/river-portals.conf" "$config_dir/xdg-desktop-portal/river-portals.conf"
